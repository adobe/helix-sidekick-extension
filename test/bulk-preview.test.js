  ...
  it('Bulk preview plugin handles content error', async () => {
    ...
    nock.bulkJob(setup, {
      resources: [
        ...
        { path: '/assets/animation-1.mp4', status: 413, error: 'MP4 is longer than 2 minutes' },
        { path: '/assets/animation-2.mp4', status: 413, error: 'MP4 has a higher bitrate than 300 KB/s' },
