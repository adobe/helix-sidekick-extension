...
describe('Test extension utils', () => {
  ...
  it('getConfigMatches', async () => {
    ...
    expect(utils.getConfigMatches(CONFIGS, 'https://foo.sharepoint.com/sites/foo/Shared%20Documents/sites/foo/drafts/example.pdf?CT=0657697518721&OR=ItemsView').length).to.equal(1);
